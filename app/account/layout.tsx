    ...
    <div className="account-shell">
      <header className="account-shell__header">
        ...
        <nav className="account-shell__nav" aria-label="Account">
          ...
          <a
            className="account-shell__discord"
            href="https://discord.gg/rvmADXwAzR"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="R.A.T.S. Discord server (opens in new tab)"
            title="Discord"
          >
            <svg
              width="22"
